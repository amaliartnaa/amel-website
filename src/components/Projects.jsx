...
const Projects = () => {
    ...
    return (
        <div id="projects" className="projects-container w-full  md:w-full min-h-screen flex flex-col items-center bg-cyan-100">
            <h1 className="text-black text-5xl font-bold font-sans mb-16 mt-40">My Projects</h1>
            <div className="mx-auto text-center grid grid-cols-1 sm: grid-rows-2 md:grid-rows-2 lg:grid-cols-2 gap-4">
